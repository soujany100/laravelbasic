...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request) {
        ...
        if($request->hasFile('image')) {
            foreach($request->file('image') as $img) {
                ...
                $imgs->resize(150,150)->save(public_path('upload/productimg/'.$name_gen));// width, height in param
    ...
    public function EditProduct($id) {
        ...
        return view('admin.backend.product.edit_product', compact('categories','brands','suppliers','warehouses','editData','multiimage'));
    } // End Method
